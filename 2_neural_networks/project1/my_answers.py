...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        self.weights_hidden_to_output = np.random_normal(0.0,
    ...
    def train(self, features, targets):
        ...
        '''
        n_records = features.shape[0] # note .shape(num_rows, num_cols)
        ...
        for X, y in zip(features, targets):
            ...
            delta_weights_i_h, delta_weights_h_o = \
                                        self.backpropagation(final_outputs,
                                        hidden_outputs, X, y,
                                        delta_weights_i_h, delta_weights_h_o)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y,
        ...
        delta_weights_i_h: change in weights from inputs to hidden layers
        delta_weights_h_o: change in weights from hidden to output layers

        '''
        # In a few places, this post on Knowledge (https://knowledge.udacity.com/questions/178799) helped me with numpy array sizes
    ...
    def run(self, features):
        ...
        #       calculations
        # Signals into final output layers
        final_inputs = hidden_outputs.dot(self.weights_hidden_to_output)

        # Signals from final output layers
        final_outputs = final_inputs
